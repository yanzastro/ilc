...
def ilc_cib(Freq,Td,dbeta,beta1,beta2):
    Spec_d = fv_d_i(Freq,Td,dbeta)
    Spec_y = fv_y_i(Freq)
    Sigma = fv_cmb_i(Freq)
    Spec_cib = np.zeros(Freq.size)
...
def ilc_cib_42(Freq,Td,dbeta,beta1,beta2):
    Spec_d = fv_d_i(Freq,Td,dbeta)
    Spec_y = fv_y_i(Freq)
    Sigma = fv_cmb_i(Freq)
    Spec_cib = np.zeros(Freq.size)
